...
<dl class="leftmenu">
    ...
    <dd>
        <div class="title">
            <span><img src="/admin/views/images/leftico01.png" /></span>管理信息
        </div>
        <ul class="menuson">
            ...
            <li>
                <div class="header">
                    <cite></cite>
                    <a href="/admin/main/admin" target="rightFrame">首页模版</a>
                    <i></i>
                </div>
                <ul class="sub-menus">
    ...
    <dd>
        <div class="title">
            <span><img src="/admin/views/images/leftico02.png" /></span>其他设置
        </div>
        <ul class="menuson">
    ...
    <dd><div class="title"><span><img src="/admin/views/images/leftico03.png" /></span>编辑器</div>
        <ul class="menuson">
    ...
    <dd><div class="title"><span><img src="/admin/views/images/leftico04.png" /></span>日期管理</div>
        <ul class="menuson">
            <li><cite></cite><a href="#">自定义</a><i></i></li>
            <li><cite></cite><a href="#">常用资料</a><i></i></li>
            <li><cite></cite><a href="#">信息列表</a><i></i></li>
