...
<div class="rightinfo">
    ...
    <div class="tools">
        ...
        <ul class="toolbar">
            <a href="/admin/category/category_add"><li class="form"><span><img src="/admin/views/images/t01.png" /></span>添加</li></a>
            <li class="click"><span><img src="/admin/views/images/t02.png" /></span>修改</li>
            <li><span><img src="/admin/views/images/t03.png" /></span>删除</li>
            <li><span><img src="/admin/views/images/t04.png" /></span>统计</li>
        </ul>


        <ul class="toolbar1">
            <li><span><img src="/admin/views/images/t05.png" /></span>设置</li>
        </ul>
    ...
    <table class="tablelist">
        ...
        <tr>
            ...
            <th>编号<i class="sort"><img src="/admin/views/images/px.gif" /></i></th>
            <th>标题</th>
            <th>用户</th>
            <th>籍贯</th>
            <th>发布时间</th>
    ...
    <div class="tip">
        ...
        <div class="tipinfo">
            <span><img src="/admin/views/images/ticon.png" /></span>
            <div class="tipright">
                <p>是否确认对信息的修改 ？</p>
